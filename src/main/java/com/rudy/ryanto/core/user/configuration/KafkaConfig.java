package com.rudy.ryanto.core.user.configuration;
...
public class KafkaConfig {
    ...
    /**
     * This class is configuration for producer and consumer kafka.
     */
    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapAddress;
    @Value("${spring.kafka.schema.registry.url.key:schema.registry.url}")
